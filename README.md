...
> **Gemi personeli (yağcı) vardiyalarını yönetmek için geliştirilmiş, NLP destekli akıllı öneri motoruna sahip bir Streamlit uygulaması.**
...
- [🧩 Yapboz (İnteraktif Vardiya Tahtası)](#-yapboz-i̇nteraktif-vardiya-tahtası)
- [⚡ Acil Panel](#-acil-panel)
- [🚢 Gemiler & Makine Yönetimi](#-gemiler--makine-yönetimi)
...
- 📞 **Anlık İzin Yerine:** Bir personel aniden izin istediğinde, yerine önerilecek en uygun **5 adayı** sıralar.
...
- ✏️ **Düzenleme ve silme:** Gemi ve makine tipleri ayrı ayrı düzenlenebilir veya silinebilir. *Bağlı personel varsa silmeye izin verilmez.*
...
- 🗑️ **İzin silme:** Kayıtlı izinler tek tek silinebilir.
